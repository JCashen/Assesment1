...
def seven(input):
	vowel = 0
	vowel_amount = list(input.lower())
	for vowels in range(len(vowel_amount)):
		if vowel_amount[vowels] == "a" or vowel_amount[vowels] == "e" or vowel_amount[vowels] == "i" or vowel_amount[vowels] == "o" or vowel_amount[vowels] == "u":
			vowel += 1
